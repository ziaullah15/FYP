    ...
    if (typeof window.ethereum !== 'undefined'){
      setStatus("Wait...")
          ...
          try {
              ...
              const sendTX = await contract.listNft(TokenAddr , ercAddr , Id , price)
              // await sendTX.wait()
              console.log(sendTX)
...
'>
    <div className='mainbreadcumb'>
      <div className='container'>
        <div className='row m-10-hor'>
          <div className='col-12'>
            <h2 className='text-center'>Listing</h2>
          </div>
        </div>
          </div>
      ...
      <Form>
        ...
        <Button className='my-2' variant="primary" onClick={tokenURI}>ListNft</Button>
