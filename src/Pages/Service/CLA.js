    ...
    if (typeof window.ethereum !== 'undefined'){
      setStatus("Wait...")
          ...
          try {
              ...
              const sendTX = await contract.cancelListorAuction(Id);
              // await sendTX.wait()
              console.log(sendTX)
...
'>
    <div className='mainbreadcumb'>
      <div className='container'>
        <div className='row m-10-hor'>
          <div className='col-12'>
            <h2 className='text-center'>Cancel List/Auction</h2>
          </div>
        </div>
          </div>
          <Container className="Auction ">
      {/* <h2>Cancel List/Auction</h2> */}
      ...
      <Form>
        ...
        <Button className='my-2' variant="primary" onClick={auction}>CancelList/Auction</Button>
